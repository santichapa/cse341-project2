...
const { validateSpellcaster } = require("../middleware/validate");
 ...
 */
router.post("/", isAuthenticated, validateSpellcaster, async (req, res) => {
    try {
 ...
 */
router.put("/:id", isAuthenticated, validateSpellcaster, async (req, res) => {
    try {
